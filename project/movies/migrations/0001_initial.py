    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='укажите сумму в $', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='укажите сумму в $', verbose_name='Сборы в США')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='укажите сумму в $', verbose_name='Сборы в мире')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.Actor', verbose_name='режисcер')),
                ('ganre', models.ManyToManyField(to='movies.Genre', verbose_name='жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
